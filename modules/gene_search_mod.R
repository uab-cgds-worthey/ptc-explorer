    ...
    column(
      ...
      fluidRow(
        column(4,
          ...
          h4(
            style = "color:darkred; justify-content: center !important;",
          ...
          # ),
          tags$p(
            style = "font-size: 95% !important; color:grey;",
